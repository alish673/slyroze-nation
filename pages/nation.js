...
export default function Nation() {
  ...
  return (
    <div className="relative min-h-screen bg-black text-white">
      ...
      <main className="relative z-10 container mx-auto p-4 sm:p-6 md:p-8 text-center space-y-6">
        <h1 className="text-4xl font-bold">Welcome to Slyroze Nation</h1>
      ...
      {/* Nation Map Overlay below everything */}
      <NationMapOverlay />
    </div>
  );
        }
